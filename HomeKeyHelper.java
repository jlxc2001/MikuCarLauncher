...
public class AppDrawerSettingsActivity extends Activity {
    ...
    private void buildUi() {
        ...
        Button rebuildThumbs = addButton(root, "手动更新 APP 略缩图缓存");
        ...
        Button clearThumbs = addButton(root, "清空 APP 略缩图缓存");
        clearThumbs.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                AppDrawerCacheManager.clearCache(AppDrawerSettingsActivity.this);
                Toast.makeText(AppDrawerSettingsActivity.this, "已清空 APP 略缩图缓存，下次打开应用抽屉会重新生成", Toast.LENGTH_LONG).show();
            }
        });
    ...
    private void rebuildAppThumbCache() {
        Toast.makeText(this, "正在后台更新 APP 略缩图缓存…", Toast.LENGTH_SHORT).show();
        AppDrawerCacheManager.rebuildCacheAsync(this, new AppDrawerCacheManager.RefreshCallback() {
            ...
            public void onFinished(boolean success, int count) {
                if (success) {
                    Toast.makeText(AppDrawerSettingsActivity.this, "APP 略缩图缓存已更新：" + count + " 个应用", Toast.LENGTH_LONG).show();
                } else {
                    Toast.makeText(AppDrawerSettingsActivity.this, "APP 略缩图缓存更新失败", Toast.LENGTH_LONG).show();
                }
            }
        });
    }
